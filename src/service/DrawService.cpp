...
bool DrawService::Init() {
    ...
    thunks_.resetShade = reinterpret_cast<void (__thiscall*)(void*)>(0x007D3290);
    ...
    thunks_.setDefaultRenderState = reinterpret_cast<void (__thiscall*)(void*)>(0x007D5200);
    thunks_.setDefaultRenderStateUnilaterally = reinterpret_cast<void (__thiscall*)(void*)>(0x007D5230);
    ...
    thunks_.setVertexBuffer = reinterpret_cast<void (__thiscall*)(void*)>(0x007D2970);
    ...
    thunks_.setTransparency = reinterpret_cast<void (__thiscall*)(void*)>(0x007D2A20);
    thunks_.resetTransparency = reinterpret_cast<void (__thiscall*)(void*)>(0x007D2A30);
